...
# Generated by qmake (2.01a) (Qt 4.7.0) on: Sat Apr 2 23:07:57 2011
# Project:  vset.pro
# Template: app
...
SOURCES       = src/mainwindowimpl.cpp \
		...
		src/Workspace.cpp build/moc_mainwindowimpl.cpp \
		build/moc_animatorwindow.cpp
OBJECTS       = build/mainwindowimpl.o \
		build/main.o \
		build/animatorwindow.o \
		build/Experiment.o \
		build/ShotPoint.o \
		build/pugixml.o \
		build/Model.o \
...
$(TARGET): build/ui_mainwindow.h build/ui_animatorwindow.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/vset1.0.0/ && $(COPY_FILE) --parents src/mainwindowimpl.h src/animatorwindow.h src/Experiment.h src/ShotPoint.h src/pugiconfig.hpp src/pugixml.hpp src/Model.h src/ExperimentManager.h src/Workspace.h build/vset1.0.0/ && $(COPY_FILE) --parents src/mainwindowimpl.cpp src/main.cpp src/animatorwindow.cpp src/Experiment.cpp src/ShotPoint.cpp src/pugixml.cpp src/Model.cpp src/TimeModel.cpp src/VelocityModel.cpp src/PerturbationModel.cpp src/CoverageModel.cpp src/ExperimentManager.cpp src/Workspace.cpp build/vset1.0.0/ && $(COPY_FILE) --parents ui/mainwindow.ui ui/animatorwindow.ui build/vset1.0.0/ && (cd `dirname build/vset1.0.0` && $(TAR) vset1.0.0.tar vset1.0.0 && $(COMPRESS) vset1.0.0.tar) && $(MOVE) `dirname build/vset1.0.0`/vset1.0.0.tar.gz . && $(DEL_FILE) -r build/vset1.0.0
...
compiler_moc_header_make_all: build/moc_mainwindowimpl.cpp build/moc_animatorwindow.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) build/moc_mainwindowimpl.cpp build/moc_animatorwindow.cpp
...
compiler_uic_make_all: build/ui_mainwindow.h build/ui_animatorwindow.h
compiler_uic_clean:
	-$(DEL_FILE) build/ui_mainwindow.h build/ui_animatorwindow.h
