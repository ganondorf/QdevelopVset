...
# Generated by qmake (2.01a) (Qt 4.7.0) on: Thu Mar 10 01:13:38 2011
# Project:  vset.pro
# Template: app
...
SOURCES       = src/mainwindowimpl.cpp \
		...
		src/ExperimentManager.cpp build/moc_mainwindowimpl.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/vset1.0.0/ && $(COPY_FILE) --parents src/mainwindowimpl.h src/animatorwindow.h src/Experiment.h src/ShotPoint.h src/pugiconfig.hpp src/pugixml.hpp src/Model.h src/ExperimentManager.h build/vset1.0.0/ && $(COPY_FILE) --parents src/mainwindowimpl.cpp src/main.cpp src/animatorwindow.cpp src/Experiment.cpp src/ShotPoint.cpp src/pugixml.cpp src/Model.cpp src/TimeModel.cpp src/VelocityModel.cpp src/PerturbationModel.cpp src/CoverageModel.cpp src/ExperimentManager.cpp build/vset1.0.0/ && $(COPY_FILE) --parents ui/mainwindow.ui ui/animatorwindow.ui build/vset1.0.0/ && (cd `dirname build/vset1.0.0` && $(TAR) vset1.0.0.tar vset1.0.0 && $(COMPRESS) vset1.0.0.tar) && $(MOVE) `dirname build/vset1.0.0`/vset1.0.0.tar.gz . && $(DEL_FILE) -r build/vset1.0.0
